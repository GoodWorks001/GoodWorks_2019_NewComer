...
<div align="center">
	...
	<%-- xmlに飛ばす --%>
	<form action="http://localhost:8080/web/Thinkyou" method="post">
		<table align="center">
			<tr>
				<td>
					<button type="submit" name="next" value="next">はい</button>
				</td>
				<td>
					<button type="submit" name="back" value="back">いいえ</button>
				</td>
			</tr>
		</table>
	</form>
