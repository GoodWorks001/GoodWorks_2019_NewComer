...
<h3 align="right"><%="ログイン中：" + session.getAttribute("login_name")%></h3>
	...
	<table border="1" width="500" cellspacing="0" align="center"
		...
		<tr>
			...
			<%
					...
					out.println(nfCur.format(price_zai));
				%>
			</td>
		</tr>
		<tr>
	...
	<form action="/Ex/kakunin" method="post">
		<div align="center">
			<table>
				<tr>
					<td><button type="submit" name="back" value="back">いいえ</button></td>
					<td><button type="submit" name="next" value="next">はい</button></td>
				</tr>
			</table>
		</div>
	</form>
