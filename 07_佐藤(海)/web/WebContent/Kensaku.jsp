...
<form action="http://localhost:8080/web/Kensaku2" method="post">
	<h1>
		<p align="center">検索</p>
	</h1>
	<h3>

	<p align="center">検索結果が優先されます</p>
	</h3>
	<br>
	<p align="center">
...
<% if(flg==1){%>
		...
		<tr>
			...
			<td align="center"><form action="http://localhost:8080/web/Syousai" method="POST"">
					<input type="submit" value="詳細1" name="ss"></td>
		</tr>
		</form>
<%} %>
...
<tr>
		...
		<tr>
			...
			<td>￥<%=request.getAttribute("PRICE") %></td>
			<td align="center"><form action="http://localhost:8080/web/Syousai" method="POST"">
					<input type="submit" value="詳細2" name="ss"></td>
		</tr>
		</form>
		<%} %>
		...
		<tr>
			...
			<td>￥<%=request.getAttribute("PRICE") %></td>
			<td align="center"><form action="http://localhost:8080/web/Syousai" method="POST"">
					<input type="submit" value="詳細3" name="ss"></td>
		</tr>
		</form>
			<%} %>
